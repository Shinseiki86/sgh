...
class CreateGerenciasProcesosTable extends Migration
{
    private $nomTabla = 'GERENCIAS_PROCESOS';
    ...
    public function up()
    {
        $commentTabla = 'Tabla de rompimiento (muchos-a-muchos) para asociar Gerencia con Procesos.';
