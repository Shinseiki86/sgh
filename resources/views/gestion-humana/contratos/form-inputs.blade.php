...
@include('widgets.forms.input', ['type'=>'select', 'name'=>'PROS_ID', 'label'=>'Prospecto', 'data'=>$arrProspectos, 'options'=>['data-live-search'=>'true']])

@include('widgets.forms.input', ['type'=>'select', 'name'=>'EMPL_ID', 'label'=>'Empleador', 'data'=>$arrEmpleadores, 'options'=>['data-live-search'=>'true']])
...
@include('widgets.forms.input', ['type'=>'select', 'column'=>8, 'name'=>'CARG_ID', 'label'=>'Cargo', 'data'=>$arrCargos, 'options'=>['data-live-search'=>'true']])
@include('widgets.forms.input', ['type'=>'date', 'column'=>4, 'name'=>'CONT_FECHAINGRESO', 'label'=>'Fecha de Ingreso' ])

@include('widgets.forms.input', ['type'=>'select', 'column'=>6, 'name'=>'CIUD_CONTRATA', 'label'=>'Ciudad de Contratación', 'data'=>$arrCiudades, 'options'=>['data-live-search'=>'true']])
@include('widgets.forms.input', ['type'=>'select', 'column'=>6, 'name'=>'CIUD_SERVICIO', 'label'=>'Ciudad de Servicio', 'data'=>$arrCiudades, 'options'=>['data-live-search'=>'true']])
...
@include('widgets.forms.input', ['type'=>'select', 'column'=>10, 'name'=>'JEFE_ID', 'label'=>'Jefe Inmediato', 'data'=>$arrJefes, 'options'=>['data-live-search'=>'true']])
