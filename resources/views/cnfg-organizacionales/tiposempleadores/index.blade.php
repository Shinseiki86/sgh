...
@section('page_heading')
	<div class="row">
		...
		<div id="btns-top" class="col-xs-4 col-md-6 col-lg-6 text-right">
			<a class='btn btn-primary' role='button' href="{{ route('tiposempleadores.create') }}" data-tooltip="tooltip" title="Crear Nuevo">
	...
	<table class="table table-striped" id="tabla">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<!-- Botón Editar (edit) -->
					<a class="btn btn-small btn-info btn-xs" href="{{ route('tiposempleadores.edit', [ 'TIEM_ID' => $tipoempleador->TIEM_ID ] ) }}" data-tooltip="tooltip" title="Editar">
