...
<div class="row ">
	<div class="form-horizontal hidden viewInfoAusentismo panel panel-default" ng-show="showResult" style="margin-top: 25px;padding-left: 35px;">
		<!-- Diagnostico -->
		<div class="row" >
			@include('widgets.forms.input', ['type'=>'text', 'column'=>3, 'name'=>'CIE10A', 'label'=>'CIE10','options'=>['ng-model'=>'ausentismo.ausentismo.diagnostico.DIAG_CODIGO','disabled'=>true]])
		...
		<div class="row">
			@include('widgets.forms.input', ['type'=>'text', 'column'=>5, 'name'=>'COAU_ID2', 'label'=>'Concepto Ausencia','options'=>['ng-model'=>'ausentismo.ausentismo.conceptoausencia.COAU_DESCRIPCION','disabled'=>true]])
		...
		<div class="row">
			...
			@include('widgets.forms.input', ['type'=>'text', 'column'=>3, 'name'=>'AUSE_FECHAACCIDENTE', 'label'=>'Fecha de Accidente','options'=>['ng-model'=>'ausentismo.ausentismo.AUSE_FECHAACCIDENTE','disabled'=>true] ])
		</div>
		<div class="row">
			...
			@include('widgets.forms.input', ['type'=>'number', 'column'=>5, 'name'=>'AUSE_IBC', 'label'=>'Ingreso Base de Cotizacion','options'=>['ng-model'=>'ausentismo.ausentismo.AUSE_IBC','disabled'=>true]])
		...
		<div class="row">
			...
			@include('widgets.forms.input', [ 'type'=>'textarea','column'=>11, 'name'=>'AUSE_OBSERVACIONES', 'label'=>'Observaciones', 'options'=>['maxlength' => '300','ng-model'=>'ausentismo.ausentismo.AUSE_OBSERVACIONES','disabled'=>true] ])
		</div>
		<div class="">
