...
@section('section')
	...
	{{ Form::model($centrocosto, ['action' => ['CentroscostosController@update', $centrocosto->CECO_ID ], 'method' => 'PUT', 'class' => 'form-horizontal' ]) }}
		...
		<div class="form-group">
			<div class="col-md-6 col-md-offset-4 text-right">
				<a class="btn btn-warning" role="button" href="{{ URL::to('admin/centrocostos/') }}" data-tooltip="tooltip" title="Regresar">
