...
@section('section')
	...
	{{ Form::open(['route' => 'admin.centroscostos.store', 'class' => 'form-horizontal']) }}
		...
		<div class="form-group{{ $errors->has('GERE_ID') ? ' has-error' : '' }}">
			...
			<div class="col-md-6">
				{{ Form::select('GERE_ID', [null => 'Seleccione una gerencia'] + $arrGerencias , old('GERE_ID'), [
		...
		<div class="form-group">
			<div class="col-md-6 col-md-offset-4 text-right">
				<a class="btn btn-warning" role="button" href="{{ URL::to('admin/centroscostos/') }}" data-tooltip="tooltip" title="Regresar">
