...
@section('section')
	...
	{{ Form::model($clasecontrato, ['action' => ['ClasescontratosController@update', $clasecontrato->CLCO_ID ], 'method' => 'PUT', 'class' => 'form-horizontal' ]) }}
		...
		<div class="form-group">
			<div class="col-md-6 col-md-offset-4 text-right">
				<a class="btn btn-warning" role="button" href="{{ URL::to('admin/clasescontratos/') }}" data-tooltip="tooltip" title="Regresar">
