...
@section('page_heading', 'Actualizar Estado de contrato '.$estadocontrato->CNOS_ID)

@section('section')

	{{ Form::model($estadocontrato, ['action' => ['EstadoscontratosController@update', $estadocontrato->ESCO_ID ], 'method' => 'PUT', 'class' => 'form-horizontal' ]) }}
