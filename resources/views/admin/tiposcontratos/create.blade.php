...
@section('section')
	...
	{{ Form::open(['route' => 'admin.tiposcontratos.store', 'class' => 'form-horizontal']) }}
		...
		<div class="form-group">
			<div class="col-md-6 col-md-offset-4 text-right">
				<a class="btn btn-warning" role="button" href="{{ URL::to('admin/tiposcontratos/') }}" data-tooltip="tooltip" title="Regresar">
