...
@section('section')
	...
	{{ Form::open(['route' => 'admin.ciudades.store', 'class' => 'form-horizontal']) }}
		...
		<div class="form-group">
			<div class="col-md-6 col-md-offset-4 text-right">
				<a class="btn btn-warning" role="button" href="{{ URL::to('admin/ciudades/') }}" data-tooltip="tooltip" title="Regresar">
